Version 1 of Serialization (for Glulx only) by Brady Garvin begins here.
...
To fail:
	say "[low-level runtime failure in]Serialization[with explanation]I....[terminating the story]".
